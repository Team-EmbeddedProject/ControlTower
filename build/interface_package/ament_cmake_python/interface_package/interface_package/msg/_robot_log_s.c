...
bool interface_package__msg__robot_log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interface_package.msg._robot_log.RobotLog", full_classname_dest, 41) == 0);
  }
  interface_package__msg__RobotLog * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of RobotLog */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interface_package.msg._robot_log");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotLog");
